...
(function WatchSyncMain() {
  ...
  const REACTIONS_ROW_2 = [
    { id: 'heart', emoji: '❤️', label: 'Love' },
    { id: 'cry', emoji: '😭', label: 'Crying' },
    { id: 'clap', emoji: '👏', label: 'Clap' },
    { id: 'fire', emoji: '🔥', label: 'Fire' },
    { id: 'love', emoji: '😍', label: 'Heart eyes' },
  ];
  const REACTIONS = [...REACTIONS_ROW_1, ...REACTIONS_ROW_2];
  ...
  class ChatSidebar {
        ...
        <div class="ws-body">
          <div class="ws-main-view" data-ref="mainView">
            ...
            <footer class="ws-footer">
              <div class="ws-reaction-bars" data-ref="reactionBars">
                <div class="ws-reaction-bar" data-ref="reactionBarRow1" role="toolbar" aria-label="Quick reactions"></div>
                <div class="ws-reaction-bar" data-ref="reactionBarRow2" role="toolbar" aria-label="More reactions"></div>
              </div>
    ...
    _buildReactionBar() {
      const rows = [
        { el: this.refs.reactionBarRow1, reactions: REACTIONS_ROW_1 },
        { el: this.refs.reactionBarRow2, reactions: REACTIONS_ROW_2 },
      ];
      for (const { el, reactions } of rows) {
        if (!el) continue;
        el.replaceChildren();
